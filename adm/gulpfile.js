...
var local = 'projetos.local/gateway'; // Sem Barra no final
...
gulp.task('concatScripts', function(){
	return gulp.src([
		'./assets/js/plugins/jquery-3.2.1.min.js',
		'./assets/js/plugins/buttons.js',
		'./assets/js/plugins/jquery.validate.js',
		'./assets/js/plugins/croppie.js',
...
// Build task
gulp.task("build", gulp.series(gulp.parallel('css:minify', 'js:minify'), 'concatScripts', function copyAssets() {
	return gulp.src([
		'*.php',
		'favicon.ico',
		'assets/img/**',
